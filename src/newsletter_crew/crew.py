...
from newsletter_crew.tools.research import SearchAndContents, FindSimilar, GetContents
...
class NewsletterCrewCrew():
	...
	def llm(self):
		...
		llm = ChatGroq(model="llama3-70b-8192", groq_api_key="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")
